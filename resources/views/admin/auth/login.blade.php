...
<body x-data="{ loaded: true }" x-init="$store.theme.init()">
    <x-admin.preloader />
                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Gunakan akun pengelola untuk mengelola konten Program Studi Ilmu Komputer.
                            </p>
                        </div>
                        <div>

                            @if (session('status'))
                                <div class="mb-5 rounded-xl border p-4 border-success-500 bg-success-50 dark:border-success-500/30 dark:bg-success-500/15">
                            ...
                            <form x-data="{ submitting: false }" @submit="submitting = true" action="{{ route('admin.login.store') }}" method="post" novalidate>
                                @csrf
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}"
                                            placeholder="pengelola@prodi.ac.id"
                    ...
                    <svg class="absolute inset-0 h-full w-full opacity-15 dark:opacity-8" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <pattern id="grid" width="24" height="24" patternUnits="userSpaceOnUse">
                                <path d="M 24 0 L 0 0 0 24" fill="none" stroke="white" stroke-width="0.5" />
                            </pattern>
                        </defs>
