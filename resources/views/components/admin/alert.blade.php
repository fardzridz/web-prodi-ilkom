...
<div class="rounded-xl border p-4 {{ $containerClass }} {{ $attributes->get('class') }}">
    <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
            ...
            @endif
            @if($showLink)
                <a href="{{ $linkHref }}" class="inline-block mt-3 text-sm font-medium text-gray-500 underline dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">{{ $linkText }}</a>
            @endif
            {{ $slot }}
        </div>
    </div>
