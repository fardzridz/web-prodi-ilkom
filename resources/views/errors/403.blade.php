...
<body>
    <div class="error">
        ...
        <div class="error__bottom">
            <div class="error__subtitle">Ups!</div>
            <div class="error__description">Kamu tidak punya izin untuk mengakses halaman ini. Area ini dijaga ketat kayak resep rahasia!</div>
