...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .pushable {
            display: inline-block; margin-top: 2.5em;
            background: #961a26; border-radius: 12px; border: none;
            padding: 0; cursor: pointer; outline-offset: 4px; text-decoration: none;
        }
        .front {
            display: block; padding: 12px 42px; border-radius: 12px;
            font-size: 1.25rem; background: #e91b2f; color: white;
            transform: translateY(-6px); transition: transform 0.1s ease;
        }
...
<body>
    <div class="error">
        ...
        <div class="error__bottom">
            ...
            <div class="error__description">Sepertinya tim developer kami ngoding terlalu larut sampai halamannya ketiduran</div>
