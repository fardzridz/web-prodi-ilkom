...
<body>
    <div class="error">
        <div class="error__top">
            <div class="error__title">429</div>
        </div>
        <div class="error__bottom">
            <div class="error__subtitle">Sabar Ya...</div>
            <div class="error__description">Kamu terlalu cepat! Tunggu beberapa saat sebelum mencoba lagi.</div>
