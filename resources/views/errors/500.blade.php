...
<body>
    <div class="error">
        ...
        <div class="error__bottom">
            <div class="error__subtitle">Aduh!</div>
            <div class="error__description">Ada yang tidak beres di server kami. Tim developer sedang mengeceknya. Coba lagi nanti ya!</div>
