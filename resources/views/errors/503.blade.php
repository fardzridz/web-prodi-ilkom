...
<body>
    <div class="error">
        <div class="error__top">
            <div class="error__title">503</div>
        </div>
        <div class="error__bottom">
            <div class="error__subtitle">Tunggu Sebentar!</div>
            <div class="error__description">Website sedang dalam pemeliharaan. Kami akan segera kembali. Silakan cek lagi nanti.</div>
