...
@section('content')
<x-hero title="Dokumen" :breadcrumbs="['Dokumen' => null]" image="{{ asset('assets/images/hero/hero-1.webp') }}">
...
<section class="bg-line overflow-x-hidden py-16 lg:py-24">
    <div class="mx-auto max-w-6xl px-4 sm:px-8 lg:px-16 xl:px-0">
        <div class="anim-fade-up anim-delay-1" data-reveal>
            ...
            <h2 class="mt-4 font-display text-3xl font-bold uppercase tracking-wide text-primary sm:text-4xl lg:text-5xl anim-fade-up anim-delay-2">Pusat Dokumen</h2>
        ...
        <form method="GET" action="{{ route('documents') }}" class="mt-10">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    @endif
                    <div id="dokumen-view-toggle" class="hidden sm:inline-flex h-12 shrink-0 items-center gap-1 rounded-full border border-line bg-white p-1" role="group" aria-label="Mode tampilan dokumen">
            ...
            <div class="mt-6 flex flex-wrap items-center gap-2.5" role="group" aria-label="Filter kategori dokumen">
        ...
        @if($documents->isEmpty())
            <div class="mt-10 flex flex-col items-center justify-center rounded-xl border border-dashed border-primary/30 bg-white/60 px-6 py-14 text-center">
                ...
                <a href="{{ route('documents') }}" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-primary/80">Lihat semua dokumen →</a>
            </div>
        @else
