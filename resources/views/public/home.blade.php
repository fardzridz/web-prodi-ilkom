...
@section('content')
    <section class="hero-section relative h-[630px] min-h-0 overflow-hidden text-white bg-blue-deep max-[1024px]:h-[564px]">
        <div class="hero-media absolute inset-0 overflow-hidden bg-blue-deep bg-cover bg-center" aria-hidden="true">
            <span class="hero-slide hero-slide-one absolute inset-0 opacity-0 bg-center bg-cover backface-hidden will-change-[opacity,transform] scale-[1.04]"></span>
            <span class="hero-slide hero-slide-two absolute inset-0 opacity-0 bg-center bg-cover backface-hidden will-change-[opacity,transform] scale-[1.04]"></span>
            <span class="hero-slide hero-slide-three absolute inset-0 opacity-0 bg-center bg-cover backface-hidden will-change-[opacity,transform] scale-[1.04]"></span>
            <span class="hero-slide hero-slide-four absolute inset-0 opacity-0 bg-center bg-cover backface-hidden will-change-[opacity,transform] scale-[1.04]"></span>
        </div>
        ...
        <div class="container hero-content w-[min(100%_-_48px,var(--container))] mx-auto max-[560px]:w-[min(100%_-_32px,var(--container))] relative z-[2] h-full pt-[120px] pb-[88px] max-[1024px]:pt-16 max-[1024px]:pb-16">
            <h1 class="max-w-[800px] mt-0 mr-0 mb-4 ml-0 font-display text-[length:var(--hero-heading-size)] font-medium leading-[0.95] tracking-normal">Logika diasah.<br>Kreativitas dikembangkan.<br>Masa depan diciptakan.</h1>
            <p class="max-w-[500px] mt-4 mb-0 text-[17.6px] font-light leading-[1.6] tracking-[-0.01em] max-[1024px]:pr-9 max-[1024px]:text-[17px]">Dunia digital terus berubah, membawa tantangan dan peluang baru di setiap langkahnya. Di Program Studi Ilmu Komputer, mahasiswa belajar membangun perangkat lunak, mengelola jaringan, mengolah data, dan menciptakan solusi teknologi yang berguna bagi masyarakat.</p>
            <div class="hero-actions flex flex-wrap items-center gap-y-7 gap-x-14 mt-9 max-[560px]:grid max-[560px]:justify-items-start max-[560px]:gap-[18px]">
                <a class="button button-primary inline-flex min-h-[54px] items-center justify-center pt-[19px] pr-[37px] pb-[14px] pl-[37px] text-white text-[15px] font-bold leading-[1.1] tracking-[0.03em] uppercase bg-blue-mid" href="{{ route('profile') }}">Lihat Profil</a>
            </div>
        </div>
    </section>
    ...
    <section id="profil-section" class="intro-section section-space py-20 max-[560px]:py-16">
        <div class="container split-grid w-[min(100%_-_48px,var(--container))] mx-auto max-[560px]:w-[min(100%_-_32px,var(--container))] grid grid-cols-2 gap-[clamp(38px,6vw,76px)] items-center max-[1024px]:grid-cols-1">
            ...
            <div class="copy-block [&_h2]:m-0 [&_h2]:text-blue-dark [&_h2]:font-display [&_h2]:text-[length:var(--hero-heading-size)] [&_h2]:font-medium [&_h2]:leading-[0.95] [&_h2]:tracking-[-0.035em] max-[560px]:[&_h2]:text-[34px] [&>p]:max-w-[450px] [&>p]:my-6 [&>p]:text-grey-2 [&>p]:text-[17px] [&>p]:leading-[1.65] [&>p]:tracking-[-0.01em]">
                ...
                <h2>Tentang Ilmu Komputer</h2>
                <p>Program Studi Ilmu Komputer Universitas PGRI Wiranegara menyiapkan lulusan yang memiliki kompetensi teknologi informasi dan komputer, berjiwa entrepreneur, mampu bekerja sama, serta siap berkontribusi di tingkat nasional maupun internasional.</p>
                <a class="button button-blue inline-flex min-h-[54px] items-center justify-center pt-[19px] pr-[37px] pb-[14px] pl-[37px] text-white text-[15px] font-bold leading-[1.1] tracking-[0.03em] uppercase bg-blue-mid" href="{{ route('profile') }}#visi-misi-page">Lihat Visi Misi</a>
            </div>
        </div>
    </section>
        ...
        <div class="container w-[min(100%_-_48px,var(--container))] mx-auto max-[560px]:w-[min(100%_-_32px,var(--container))]">
            ...
            <div class="visit-grid grid grid-cols-3 gap-[34px] mt-[42px] max-[1024px]:grid-cols-1">
                @foreach ($activities as $activity)
                    <article class="visit-card [&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:text-blue-dark [&_h3]:font-display [&_h3]:text-[34px] [&_h3]:font-medium [&_h3]:leading-none [&_h3]:tracking-[-0.035em] [&_p]:text-grey-2">
